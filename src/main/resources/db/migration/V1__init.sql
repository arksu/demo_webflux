...
(
    ...
    internal_client_id varchar(64)                    not null,
...
create type order_status_type as enum ('NEW', 'AWAIT', 'DONE', 'CANCEL', 'EXPIRED');
...
insert into merchant(id, name, email)
values ('2a3e59ff-b549-4ca2-979c-e771c117f350', 'merch1', 'some@email.com');
